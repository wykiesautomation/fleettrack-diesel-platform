...
PROFILE = {
    ...
    "capabilities": [
        ...
        "DIGITAL_OUTPUT_2", "SIM808_POWER_CONTROL_RESERVED", "BATTERY_VOLTAGE",
    ...
    "channels": [
        ...
        {"key":"output_do1", "label":"Digital Output 1", "signal_type":"DIGITAL_OUTPUT", "source_type":"SIM808", "unit":"", "widget":"output", "direction":"OUTPUT", "calibratable":False, "pin":"D5", "pin_notes":"Verified physical latched/pulse output; safe boot OFF", "command_channel":"DO1"},
        {"key":"output_do2", "label":"Digital Output 2", "signal_type":"DIGITAL_OUTPUT", "source_type":"SIM808", "unit":"", "widget":"output", "direction":"OUTPUT", "calibratable":False, "pin":"D6", "pin_notes":"Verified physical latched/pulse output; safe boot OFF", "command_channel":"DO2"},
        ...
        {**output_feedback("digital_output_1_feedback", "DO1 State Feedback", "SIM808", "DO1"), "direction":"HEALTH", "pin":None, "physical_pin":"D5", "pin_notes":"Firmware state feedback for physical output D5; not assignable as a second output"},
        {**output_feedback("digital_output_2_feedback", "DO2 State Feedback", "SIM808", "DO2"), "direction":"HEALTH", "pin":None, "physical_pin":"D6", "pin_notes":"Firmware state feedback for physical output D6; not assignable as a second output"},
