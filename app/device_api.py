...
def io_studio(device_id):
    ...
    target_asset_id=request.args.get('target_asset_id',type=int);preselected_asset_id=target_asset_id if any(a.id==target_asset_id for a in compatible_assets) else dev.asset_id
