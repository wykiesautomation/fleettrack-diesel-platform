...
class WorkspaceProfile(db.Model):
    ...
    billing_email=db.Column(db.String(180))
    address=db.Column(db.String(240))
    country=db.Column(db.String(80),default='South Africa')
...
class SubscriptionPlan(db.Model):
    ...
    currency=db.Column(db.String(8),default='ZAR',nullable=False)
    included_devices=db.Column(db.Integer,default=1,nullable=False)
...
class Subscription(db.Model):
    ...
    state=db.Column(db.String(30),default='TRIAL',nullable=False,index=True)
    trial_started_at=db.Column(db.DateTime(timezone=True),default=now,nullable=False)
    ...
    next_payment_at=db.Column(db.DateTime(timezone=True))
    grace_ends_at=db.Column(db.DateTime(timezone=True))
    cancel_at_period_end=db.Column(db.Boolean,default=False,nullable=False)
    payfast_subscription_token=db.Column(db.String(180))
    created_at=db.Column(db.DateTime(timezone=True),default=now,nullable=False)
    updated_at=db.Column(db.DateTime(timezone=True),default=now,onupdate=now,nullable=False)
    customer=db.relationship('Customer')
...
class PaymentRecord(db.Model):
    ...
    provider=db.Column(db.String(30),default='PAYFAST',nullable=False)
    provider_reference=db.Column(db.String(180),unique=True,index=True)
    merchant_payment_id=db.Column(db.String(100),unique=True,index=True)
    amount_gross=db.Column(db.Float,nullable=False,default=0)
    currency=db.Column(db.String(8),default='ZAR',nullable=False)
    status=db.Column(db.String(30),default='PENDING',nullable=False,index=True)
    payment_method=db.Column(db.String(40))
    raw_summary=db.Column(db.JSON,default=dict)
