...
class DeviceConfiguration(db.Model):
    ...
    tank_capacity_l=db.Column(db.Float)
    tank_height_mm=db.Column(db.Float)
    tank_shape=db.Column(db.String(40),default='RECTANGULAR',nullable=False)
    empty_ma=db.Column(db.Float,default=4.0,nullable=False)
    full_ma=db.Column(db.Float,default=20.0,nullable=False)
    low_alarm_percent=db.Column(db.Float,default=20.0,nullable=False)
    critical_alarm_percent=db.Column(db.Float,default=10.0,nullable=False)
    rapid_drop_percent=db.Column(db.Float,default=5.0,nullable=False)
    moving_interval_seconds=db.Column(db.Integer,default=60,nullable=False)
    parked_interval_seconds=db.Column(db.Integer,default=600,nullable=False)
    calibration_points=db.Column(db.JSON,default=list)
    applied_revision=db.Column(db.Integer,default=0,nullable=False)
    apply_status=db.Column(db.String(30),default='PENDING',nullable=False,index=True)
    apply_detail=db.Column(db.String(240))
...
class DeviceCommand(db.Model):
    ...
    result_detail=db.Column(db.String(240))
