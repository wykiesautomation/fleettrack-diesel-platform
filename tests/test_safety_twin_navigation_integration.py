...
R=Path("app/routes.py").read_text(encoding="utf-8");B=Path("app/templates/base.html").read_text(encoding="utf-8");A=Path("app/templates/asset.html").read_text(encoding="utf-8");H=Path("app/templates/tracking_history.html").read_text(encoding="utf-8");T=Path("app/templates/safety_twin.html").read_text(encoding="utf-8")
